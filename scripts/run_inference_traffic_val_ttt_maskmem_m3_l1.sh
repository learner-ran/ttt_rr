...
SAM2_CFG="${SAM2_CFG:-sam2/configs/sam2.1/sam2_ttt_inference_l_traffic_restricted_maskmem_m3_l1.yaml}"
OUTPUT_MASK_DIR="${OUTPUT_MASK_DIR:-/root/autodl-tmp/output_traffic_mots_val/traffic_restricted_maskmem_m3_l1}"
DEFAULT_CHECKPOINT="/root/autodl-tmp/ttt_rr/logs/sam_ttt_traffic_restricted_maskmem_m3_l1_run1/checkpoints/checkpoint.pt"
...
echo "Running traffic_mots_semi val inference..."

...
# 模型配置（SAM 2.1 Base+）
SAM2_CFG="sam2/configs/sam2.1/sam2.1_hiera_b+_no_ttt.yaml"
SAM2_CHECKPOINT="/root/autodl-tmp/ttt_rr/checkpoints/sam2.1_hiera_base_plus.pt"

# 输出路径
OUTPUT_MASK_DIR="${OUTPUT_MASK_DIR:-/root/autodl-tmp/output_mose_val/output_mose_test_base_plus}"
LOG_FILE="${OUTPUT_MASK_DIR}/inference.log"
mkdir -p "$OUTPUT_MASK_DIR"

echo "Running SAM 2.1 base+ inference on MOSE test set..."

...
CONFIG="configs/sam2.1_training/sam2_ttt_bdd_large"
TIMESTAMP=$(date +%Y%m%d_%H%M%S)
export EXP_DIR="/root/autodl-tmp/runs/sam_ttt_bdd/${TIMESTAMP}"
mkdir -p "$EXP_DIR"
export CUDA_VISIBLE_DEVICES=0

echo "Starting SAM-TTT training on BDD100K MOTS semi..."
